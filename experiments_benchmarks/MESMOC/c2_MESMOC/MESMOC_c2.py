...
######################Algorithm input##############################
paths=''
# from benchmark_functions import toy
from benchmark_functions import c2
#this is just a toy example of how to define constraints, this means we want branin>=-20 and Currin>= -6
# constraints=[f_1_c, f_2_c] 
# def evaluation(xx,d):
#     global functions
...
for iter in range(10):
    ...
    bound=[0,1]
    Fun_bounds = [bound]*d
    initializer = torch.load(f'/Users/lidiantong/Desktop/学习资料/BayesianOpt/CMOBO/code/MESMOC-master/c2_MESMOC/train_domain_c2_{iter+1}.pt').cpu().numpy()
    ###################GP Initialisation##########################
    GPs=[]
    Multiplemes=[]
    GPs_C=[]
