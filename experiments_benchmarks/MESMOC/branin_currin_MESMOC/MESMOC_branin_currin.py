...
######################Algorithm input##############################
paths='/Users/lidiantong/Desktop/学习资料/BayesianOpt/CMOBO/code/MESMOC-master'
from benchmark_functions import branin,Currin, branin_c, Currin_c
functions=[branin,Currin]
#this is just a toy example of how to define constraints, this means we want branin>=-20 and Currin>= -6
constraints=[branin_c,Currin_c] 
def evaluation(xx,d):
    global functions
